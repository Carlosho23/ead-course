...
public class CourseServiceImpl implements CourseService {
    ...
    public void saveSubscriptionUserInCourse(CourseModel courseModel, UserModel userModel) {
        ...
        try {
            var notificationRecordCommandDto = new NotificationRecordCommandDto("Bem-Vindo(a) ao Curso: " + courseModel.getName(),
                    userModel.getFullName() + "a sua inscrição foi realizada com sucesso!", userModel.getUserId());
